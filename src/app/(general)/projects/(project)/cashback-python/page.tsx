...
export default function CashbackPython() {
    ...
    const h3_classes = "text-slate-50 text-2xl font-bold mt-30 mb-5"
            ...
            <div className="max-w-7xl mx-auto p-8">
                <article>
                    <div className="flex flex-row-reverse gap-10">
                        <nav className="hidden lg:flex flex-col text-base text-slate-400 gap-3 w-[400px]">
                            <h2 className="text-md font-semibold text-slate-200 tracking-widest uppercase mb-1">Table of
                                Contents</h2>
                            <a href="#what-is-cashback">What is Cashback.co.uk</a>
                            <a href="#optimal-images">Optimal images</a>
                            <a href="#container-based-card-layout">Container based Card layout</a>
                            <a href="#admin-changelog">Admin Changelog</a>
                            <a href="#blurred-background-card-images">Blurred background card images</a>
                        ...
                        <div className="">
                            ...
                            <h1 className={h2_classes} id="what-is-cashback.co.uk">What is Cashback.co.uk</h1>

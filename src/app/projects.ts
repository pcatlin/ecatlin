...
export const projects: ProjectsMap = {
    ...
    "plexamp-sonos-speed-dial": {
        ...
        description: "Play Plexamp music on Sonos speakers with speed-dial favourites",
        ...
        tech: [
            ...
            {name: "CSS", stackType: "frontend"},
            {name: "Python", stackType: "backend", primary: true},
            {name: "FastAPI", stackType: "backend"},
            ...
            {name: "Docker Compose", stackType: "infrastructure"},
    ...
    "plex-playlist-tool": {
        ...
        tech: [
            ...
            {name: "TypeScript", stackType: "frontend", primary: true},
            {name: "Vite", stackType: "frontend"},
            {name: "Vitest", stackType: "frontend", description: "Unit and component tests"},
            {name: "Playwright", stackType: "frontend", description: "End-to-end tests"},
            {name: "Python", stackType: "backend", primary: true},
            {name: "FastAPI", stackType: "backend", primary: true},
            {name: "Uvicorn", stackType: "backend"},
            {name: "Pydantic", stackType: "backend"},
            {name: "plexapi", stackType: "backend", description: "Plex server and OAuth"},
            {name: "spotipy", stackType: "backend", description: "Spotify Web API"},
            {name: "httpx", stackType: "backend", description: "OpenAI Chat Completions"},
            {name: "SQLite", stackType: "backend", primary: true},
            {name: "Docker", stackType: "infrastructure", primary: true},
            {name: "Docker Compose", stackType: "infrastructure"},
            {name: "Node.js", stackType: "infrastructure"},
            {name: "pytest", stackType: "backend", description: "Backend testing"},
            {name: "Spotify Web API", stackType: "tools"},
            {name: "OpenAI API", stackType: "tools"},
            {name: "Plexamp", stackType: "tools", description: "Optional preview"},
        ],
        sidebar: [
            {href: "#what-is-it", label: "What is Plex Playlist Tool?"},
            {href: "#plex-search", label: "Plex Search"},
            {href: "#spotify-matching", label: "Spotify playlist matching"},
            {href: "#ai-suggestions", label: "AI suggestions"},
            {href: "#csv-import", label: "CSV import"},
            {href: "#playlist-workflow", label: "Playlist workflow"},
            {href: "#settings-privacy-deploy", label: "Settings, privacy, and deploy"},
            {href: "#who-is-it-for", label: "Who is it for?"},
            {href: "#tech-stack", label: "Tech Stack"},
        ],
    },
    "sweepstake-genius": {
        name: "Sweepstake Genius",
        description: "Free web app for FIFA World Cup 2026 team sweepstakes—fair draw, prize pots, full fixture list, one shareable link.",
        colour: "oklch(0.55 0.15 145)",
        dt_start: new Date('2026-06-01'),
        tech: [
            {name: "React", stackType: "frontend", primary: true},
            {name: "TypeScript", stackType: "frontend", primary: true},
            {name: "Vite", stackType: "frontend"},
            {name: "Tailwind CSS", stackType: "frontend", primary: true},
            {name: "React Router", stackType: "frontend"},
            {name: "Font Awesome", stackType: "frontend"},
            {name: "Vitest", stackType: "frontend", description: "Testing"},
            {name: "Testing Library", stackType: "frontend"},
        ...
        sidebar: [
            {href: "#what-is-it", label: "What is Sweepstake Genius?"},
            {href: "#what-it-does", label: "What it does"},
            {href: "#ready-in-seconds", label: "Ready in seconds"},
            {href: "#fair-team-draw", label: "Fair team draw"},
            {href: "#flexible-prize-pots", label: "Flexible prize pots"},
            {href: "#match-schedule", label: "Full match schedule"},
            {href: "#easy-to-share", label: "Easy to share"},
            {href: "#tech-stack", label: "Tech Stack"},
        ],
    },
}
